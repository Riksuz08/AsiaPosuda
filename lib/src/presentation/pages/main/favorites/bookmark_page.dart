              ...
              Padding(
                ...
                child: Obx(
                    ...
                    itemBuilder: (context, index) {
                                ...
                                InkWell(
                                  ...
                                  child:  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        SizedBox(width: 20,),
                                        Lottie.network('https://lottie.host/d0ba0ef0-cf1e-4fa9-9ba4-f48719c429ec/InLcb3pvJ8.json',
                                          fit: BoxFit.fill,
                                        ),
                                        SizedBox(width: 20,),
                                        Column(
                                          ...
                                          children: [
                                            SizedBox(height: 15,),
                                            Text('Есть сервис доставки!',style: TextStyle(fontWeight: FontWeight.w600),),
                                            Text('Подробнее')
                                          ],
                                        )
                                      ],
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap:(){
                                        ...
                                        for(final item in FavoritesPage.checkedProducts){
                                          if(FavoritesPage.orderProducts.contains(item)){
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: 12,
                                            color: FavoritesPage.checkedProducts.isNotEmpty ? Colors.black : Colors.grey.shade500
                                        ),
                                      ),
                                    ),
                                    Row(
                                      children: [
                                        Text('Выбрать все',style: TextStyle(fontSize: 12),),
                                        Checkbox(
                                          ...
                                          onChanged: (bool? value) {
                                            setState(() {
                                              if (checkAll == true) {
                                                ...
                                                checkAll= !checkAll;
                                                FavoritesPage.checkedProducts.clear();
                                                print(FavoritesPage.checkedProducts);
                                              } else {
                                                print(checkAll);
                                                checkAll= !checkAll;
                                                FavoritesPage.checkedProducts.addAll(FavoritesPage.orderProducts);
                                                print(FavoritesPage.checkedProducts);
                                              }
                                            });
                                          },
                      ...
                      final product = FavoritesPage.orderProducts[index - 1];
                      final int count = product.quantity;
                      final bool isChecked = FavoritesPage.checkedProducts.contains(product);
                              ...
                              children: [
                                ListTile(
                                  ...
                                  title: Row(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text('${formatNumber(int.parse(product.price))} сум'),
                                      ...
                                      Checkbox(
                                        ...
                                        onChanged: (bool? value) {
                                          setState(() {
                                            if (value == true) {
                                              FavoritesPage.checkedProducts.add(product);
                                              print(FavoritesPage.checkedProducts);
                                            } else {
                                              FavoritesPage.checkedProducts.remove(product);
                                              print(FavoritesPage.checkedProducts);
                                            }
                                          });
                                        },
                          ...
                          Padding(
                            ...
                            child: ColoredBox(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Ваш заказ',style: TextStyle(
                                      fontSize: 18,
                                  ...
                                  Row(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text('Итого',style: TextStyle(color: Colors.grey),),
                                      Text(formatNumber(totalCheckedPrice().round())+' '+context.tr('uzs'),style:
                                      TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.w500
                                      ),)
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              '${formatNumber(totalCheckedPrice().round())} ' + context.tr('uzs'),
                              style: TextStyle(
                                fontSize: 18,
                              ),
                            ),
                            Text(
                              context.tr('products') + ": " + totalCheckedQuantity().toString(),
                              style: TextStyle(
                                fontSize: 12,
                                color: Colors.grey,
                              ),
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              // Perform action with FavoritesPage.checkedProducts
                            },
                            style: ElevatedButton.styleFrom(
                              primary: Color(0xFF79B531),
                            ),
